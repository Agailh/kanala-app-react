...
const Gallery = () => {
  return (
    <div id="gal" className="w-full h-[1220px] text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          <p className=" text-xl tracking-widest mb-10 text-white underline underline-offset-8">Our Place</p>
          <h1 className="py-4 text-[#e4d7b6] text-5xl font-mono">Our Cozy and Beautiful Place</h1>
          <h1 className="py-4 text-[#e4d7b6] text-3xl font-mono">Traditional Javanese House with Rice Field views</h1>
          <p className="py-4 text-white max-w-[70%] mb-6 m-auto">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
          <div className="shadow-inner flex items-center justify-center p-1 hover:scale-105 ease-in duration-300">
            <Carousel />
          </div>
        </div>
      </div>
